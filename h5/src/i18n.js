...
const messages = {
  'zh-CN': {
    ...
    'session.new.default.name': '新会话',
    'session.new.name.required': '请输入会话名称',
    ...
    'session.rename': '修改名称',
    'session.rename.confirm': '确定',
    'session.load.error': '加载失败',
    'session.main': '主会话',
    'session.none': '无会话',
    'session.deleted.hint': '当前会话已删除，请选择或创建新会话',
    // 快捷指令
    'cmd.title': '快捷指令',
    'cmd.model': '模型管理',
    ...
    'login.register.btn.loading': '注册中...',
    'login.error.required': '用户名和密码必填',
  ...
  'en': {
    ...
    'session.new.default.name': 'New Session',
    'session.new.name.required': 'Please enter a session name',
    ...
    'session.rename.confirm': 'OK',
    'session.empty': 'No sessions found',
    'session.load.error': 'Load failed',
    'session.main': 'Main Session',
    'session.none': 'No Session',
    'session.deleted.hint': 'Current session has been deleted. Please select or create a new session',
    'cmd.title': 'Commands',
    'cmd.model': 'Model',
    ...
    'login.register.btn.loading': 'Registering...',
